    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memebership', models.CharField(choices=[('B', 'B'), ('S', 'S'), ('G', 'G')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Promotion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colloection', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store.collection')),
